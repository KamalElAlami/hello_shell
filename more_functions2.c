...
/**
 * _advatoi - converts a string to an integer
 ...
 *        -1 on error
 */
void showerror(info_t *info, char *estr)
{
	_eputs(info->fname);
	_eputs(": ");
...
/**
 * remcomments - function replaces first instance of '#' with '\0'
 * @buf: address of the string to modify
 *
 * Return: Always 0;
 */
void remcomments(char *buf)
{
	int i;
